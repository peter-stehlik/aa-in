		...
		<main class="relative flex-1 min-h-[85vh] lg:ml-60 px-4 lg:px-16 pt-20">
            <?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
                ...
                <div class="container flex flex-col lg:pl-8 2xl:pl-0" id="detail">
                    ...
                    <div class="mt-20">
                        <a class="btn px-8 py-4 border-2 border-primary rounded-full bg-white hover:bg-quaternary text-primary font-semibold tracking-wide no-underline" href="<?php echo home_url(); ?>"><p><?php _e( 'späť na Aktuality', 'intranetaa' ); ?></p></a>
                    </div>
                </div>
            <?php endwhile; else : ?>
