		...
		<main class="flex-1 lg:ml-60 px-4 lg:px-8 pt-20">
			<div class="container flex flex-col mx-auto lg:mx-0">
                <div class="xl:w-3/4 lg:pt-8 pb-20 mx-auto">
                    ...
                    <div class="mt-20">
						<a class="btn px-8 py-4 rounded-lg bg-primary hover:bg-secondary text-white font-semibold tracking-wide no-underline" href="<?php echo home_url(); ?>">späť na Aktuality</a>
					</div>
                </div>
